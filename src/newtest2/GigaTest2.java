	...
	public static void main(String[] args) throws Exception {
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest1 < totalNumberOfMovesTest1) {
				if(playersTest1[currentIndexTest1].getType().equals("Charles_2")) {
					//MCTS + H(7) to play.
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest1 = new BufferedWriter(
					new FileWriter("results_50k_3b_Charles_2vMCTS_H(5).txt", true));
		...
		output1Test1.newLine();
		output1Test1.append("Charles_2 total wins: " + e2TotalWins);
		output1Test1.newLine();
		...
		output1Test1.append("Charles_2 wins as player #1 : " + e2WinAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Charles_2 wins as player #2 : " + e2WinAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("Charles_2 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Charles_2 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("Charles_2 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Charles_2 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test1.newLine();
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest2 < totalNumberOfMovesTest2) {
				...
				} else if(playersTest2[currentIndexTest2].getType().equals("Charles_2")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
//					MonteCarlo mc = new MonteCarlo(
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest2 = new BufferedWriter(
					new FileWriter("results_20k_3b_Charles_2vMCTS_H(7).txt", true));
		...
		BufferedWriter output1Test2 = new BufferedWriter(
				new FileWriter("results_50k_3b_Charles_2vMCTS_H(7).txt", true));
		output1Test2.append("========================================");
		...
		output1Test2.newLine();
		output1Test2.append("Charles_2 total wins: " + e2TotalWins);
		output1Test2.newLine();
		...
		output1Test2.append("Charles_2 wins as player #1 : " + e2WinAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Charles_2 wins as player #2 : " + e2WinAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("Charles_2 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Charles_2 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("Charles_2 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Charles_2 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test2.newLine();
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest3 = new BufferedWriter(
					new FileWriter("results_50k_3b_Charles_2vMCTS_H(10).txt", true));
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest4 = new BufferedWriter(
					new FileWriter("results_50k_3b_Charles_2vMCTS_H(5+5).txt", true));
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest5 = new BufferedWriter(
					new FileWriter("results_50k_11b_MCTS_H(5)vCharles_2.txt", true));
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest6 = new BufferedWriter(
					new FileWriter("results_50k_11b_MCTS_H(7)vCharles_2.txt", true));
