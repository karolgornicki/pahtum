...
public class GigaTest {
	...
	public static void main(String[] args) throws Exception {
		...
		/***********************************************************************
		 * Test #1: (100,000/50,000 roll-outs) MCTS + H(7)_100 v MCTS + H(7)_50 3-point board.
		 **********************************************************************/
		...
		Player[] playersTest1 =  {
				...
				new Player("MCTS_Boltzmann", "MCTS_Boltzmann", "b", 20000)
		};
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest1 < totalNumberOfMovesTest1) {
				...
				} else if(playersTest1[currentIndexTest1].getType().equals("MCTS_Boltzmann")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloHBoltzmann mc = new MonteCarloHBoltzmann(
							boardTest1.duplicate(), 
							playersTest1[currentIndexTest1].getColor(), 
							numberOfMoveTest1, 
							totalNumberOfMovesTest1);
			...
			BufferedWriter outputTest1 = new BufferedWriter(
					new FileWriter("results_20k_3b_MCTS_UCTvMCTS_Boltzmann.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest1[0].getName().equals("MCTS_Boltzmann")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest1[0].getColor())) {
					...
					//Update statistics.
					if(playersTest1[1].getName().equals("MCTS_Boltzmann")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test1.newLine();
		output1Test1.append("MCTS_Boltzmann total wins: " + e1TotalWins);
		output1Test1.newLine();
		...
		output1Test1.append("MCTS_Boltzmann wins as player #1 : " + e1WinAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("MCTS_Boltzmann wins as player #2 : " + e1WinAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("MCTS_Boltzmann draws as player #1 : " + e1DrawAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("MCTS_Boltzmann draws as player #2 : " + e1DrawAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("MCTS_Boltzmann loses as player #1 : " + e1LoseAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("MCTS_Boltzmann loses as player #2 : " + e1LoseAsPlayer2);
		output1Test1.newLine();
		...
		Player[] playersTest2 =  {
				...
				new Player("MCTS_Boltzmann", "MCTS_Boltzmann", "b", 50000)
		};
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest2 < totalNumberOfMovesTest2) {
				if(playersTest2[currentIndexTest2].getType().equals("MCTS_Boltzmann")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloHBoltzmann mc = new MonteCarloHBoltzmann(
			...
			BufferedWriter outputTest2 = new BufferedWriter(
					new FileWriter("results_50k_3b_MCTS_BoltzmannvMCTS_UCT.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest2[0].getName().equals("MCTS_Boltzmann")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest2[0].getColor())) {
					...
					//Update statistics.
					if(playersTest2[1].getName().equals("MCTS_Boltzmann")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test2.append("*Summary (50k) 3-point board t=2.5*");
		output1Test2.newLine();
		output1Test2.append("Draw occurred: " + totalDraws);
		output1Test2.newLine();
		output1Test2.append("MCTS_UCT total wins: " + e2TotalWins);
		output1Test2.newLine();
		output1Test2.append("MCTS_Boltzmann total wins: " + e1TotalWins);
		output1Test2.newLine();
		...
		//Write statistics for Random AI.
		output1Test2.append("MCTS_Boltzmann wins as player #1 : " + e1WinAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("MCTS_Boltzmann wins as player #2 : " + e1WinAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("MCTS_Boltzmann draws as player #1 : " + e1DrawAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("MCTS_Boltzmann draws as player #2 : " + e1DrawAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("MCTS_Boltzmann loses as player #1 : " + e1LoseAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("MCTS_Boltzmann loses as player #2 : " + e1LoseAsPlayer2);
		output1Test2.newLine();
		...
		//Players participating in the test case.
		Player[] playersTest3 =  {
				new Player("MCTS_Boltzmann_5", "MCTS_Boltzmann_5", "w", 20000),
				new Player("MCTS_Boltzmann_7", "MCTS_Boltzmann_7", "b", 20000)
		};
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest3 < totalNumberOfMovesTest3) {
				if(playersTest3[currentIndexTest3].getType().equals("MCTS_Boltzmann_7")) {
					//MCTS + H(5) to play.
					Tuple<Integer, Integer> move;
				...
				} else if(playersTest3[currentIndexTest3].getType().equals("MCTS_Boltzmann_5")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
			...
			BufferedWriter outputTest3 = new BufferedWriter(
					new FileWriter("results_20k_3b_MCTS_Boltzmann_5vMCTS_Boltzmann_7.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest3[0].getName().equals("MCTS_Boltzmann_7")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest3[0].getColor())) {
					...
					//Update statistics.
					if(playersTest3[1].getName().equals("MCTS_Boltzmann_7")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test3.append("*Summary 20k roll-outs 3 point board, t=2/5 (for both)*");
		output1Test3.newLine();
		output1Test3.append("Draw occurred: " + totalDraws);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_5 total wins: " + e2TotalWins);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_7 total wins: " + e1TotalWins);
		output1Test3.newLine();
		output1Test3.append("Play time: " + (endTimeTest3 - startTimeTest3)/1000 + " seconds.");
		output1Test3.newLine();

		//Write statistics for MCTS.
		output1Test3.append("MCTS_Boltzmann_5 wins as player #1 : " + e2WinAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_5 wins as player #2 : " + e2WinAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_5 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_5 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_5 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_5 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test3.newLine();

		//Write statistics for Random AI.
		output1Test3.append("MCTS_Boltzmann_7 wins as player #1 : " + e1WinAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_7 wins as player #2 : " + e1WinAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_7 draws as player #1 : " + e1DrawAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_7 draws as player #2 : " + e1DrawAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_7 loses as player #1 : " + e1LoseAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("MCTS_Boltzmann_7 loses as player #2 : " + e1LoseAsPlayer2);
		output1Test3.newLine();
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest4 < totalNumberOfMovesTest4) {
				if(playersTest4[currentIndexTest4].getType().equals("MCTS_Boltzmann_7")) {
					//MCTS + H(5) to play.
					Tuple<Integer, Integer> move;
				...
				} else if(playersTest4[currentIndexTest4].getType().equals("MCTS_Boltzmann_5")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
			...
			BufferedWriter outputTest4 = new BufferedWriter(
					new FileWriter("results_20k_11b_MCTS_Boltzmann_5vMCTS_Boltzmann_7.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest4[0].getName().equals("MCTS_Boltzmann_7")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest4[0].getColor())) {
					...
					//Update statistics.
					if(playersTest4[1].getName().equals("MCTS_Boltzmann_7")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test4.append("*Summary 20k roll-outs 11 point board, t=2/5 (both)*");
		output1Test4.newLine();
		output1Test4.append("Draw occurred: " + totalDraws);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_5 total wins: " + e2TotalWins);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_7 total wins: " + e1TotalWins);
		output1Test4.newLine();
		output1Test4.append("Play time: " + (endTimeTest4 - startTimeTest4)/1000 + " seconds.");
		output1Test4.newLine();

		//Write statistics for MCTS.
		output1Test4.append("MCTS_Boltzmann_5 wins as player #1 : " + e2WinAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_5 wins as player #2 : " + e2WinAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_5 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_5 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_5 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_5 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test4.newLine();

		//Write statistics for Random AI.
		output1Test4.append("MCTS_Boltzmann_7 wins as player #1 : " + e1WinAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_7 wins as player #2 : " + e1WinAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_7 draws as player #1 : " + e1DrawAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_7 draws as player #2 : " + e1DrawAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_7 loses as player #1 : " + e1LoseAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("MCTS_Boltzmann_7 loses as player #2 : " + e1LoseAsPlayer2);
		output1Test4.newLine();
...
//							getSimulationNumber());
				...
				} else if(playersTest5[currentIndexTest5].getType().equals("MCTS_Boltzmann_5")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloH5Boltzmann mc = new MonteCarloH5Boltzmann(
			...
			BufferedWriter outputTest5 = new BufferedWriter(
					new FileWriter("results_20k_11b_MCTS_Boltzmann_5vCharles_2.txt", true));
		...
		output1Test5.append("*Summary 20k roll-outs 11 point board, t=2.5*");
		output1Test5.newLine();
		output1Test5.append("Draw occurred: " + totalDraws);
		output1Test5.newLine();
		output1Test5.append("MCTS_Boltzmann_5 total wins: " + e2TotalWins);
		output1Test5.newLine();
		...
		//Write statistics for MCTS.
		output1Test5.append("MCTS_Boltzmann_5 wins as player #1 : " + e2WinAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("MCTS_Boltzmann_5 wins as player #2 : " + e2WinAsPlayer2);
		output1Test5.newLine();
		output1Test5.append("MCTS_Boltzmann_5 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("MCTS_Boltzmann_5 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test5.newLine();
		output1Test5.append("MCTS_Boltzmann_5 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("MCTS_Boltzmann_5 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test5.newLine();
		...
		//Players participating in the test case.
		Player[] playersTest6 =  {
				new Player("MCTS_Boltzmann", "MCTS_Boltzmann", "w", 20000),
				new Player("Charles_2", "Charles_2", "b", 0)
		};
...
//							getSimulationNumber());
				...
				} else if(playersTest6[currentIndexTest6].getType().equals("MCTS_Boltzmann")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloHBoltzmann mc = new MonteCarloHBoltzmann(
			...
			BufferedWriter outputTest6 = new BufferedWriter(
					new FileWriter("results_20k_3b_MCTS_BoltzmannvCharles_2.txt", true));
		...
		output1Test6.append("*Summary 20k roll-outs 3 point board, t=2.5*");
		output1Test6.newLine();
		output1Test6.append("Draw occurred: " + totalDraws);
		output1Test6.newLine();
		output1Test6.append("MCTS_Boltzmann total wins: " + e2TotalWins);
		output1Test6.newLine();
		...
		output1Test6.append("MCTS_Boltzmann wins as player #1 : " + e2WinAsPlayer1);
		output1Test6.newLine();
		output1Test6.append("MCTS_Boltzmann wins as player #2 : " + e2WinAsPlayer2);
		output1Test6.newLine();
		output1Test6.append("MCTS_Boltzmann draws as player #1 : " + e2DrawAsPlayer1);
		output1Test6.newLine();
		output1Test6.append("MCTS_Boltzmann draws as player #2 : " + e2DrawAsPlayer2);
		output1Test6.newLine();
		output1Test6.append("MCTS_Boltzmann loses as player #1 : " + e2LoseAsPlayer1);
		output1Test6.newLine();
		output1Test6.append("MCTS_Boltzmann loses as player #2 : " + e2LoseAsPlayer2);
		output1Test6.newLine();
