...
public class GigaTestBoltzmann {
	...
	public static void main(String[] args) throws Exception {
		...
		Player[] playersTest1 =  {
				new Player("BoltzmannH5", "BoltzmannH5", "w", 100000),
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest1 < totalNumberOfMovesTest1) {
				if(playersTest1[currentIndexTest1].getType().equals("BoltzmannH5")) {
					//MCTS + H(7) to play.
					Tuple<Integer, Integer> move;
					//BOltzmann will select move.
			...
			BufferedWriter outputTest1 = new BufferedWriter(
					new FileWriter("results_100k_3b_BoltzmannH5vCharles_2.txt", true));
		...
		output1Test1.append("*Summary (100k) 3-point board (t=2.5)*");
		output1Test1.newLine();
		output1Test1.append("Draw occurred: " + totalDraws);
		output1Test1.newLine();
		output1Test1.append("BoltzmannH5 total wins: " + e2TotalWins);
		output1Test1.newLine();
		...
		//Write statistics for BoltzmannH5.
		output1Test1.append("BoltzmannH5 wins as player #1 : " + e2WinAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("BoltzmannH5 wins as player #2 : " + e2WinAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("BoltzmannH5 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("BoltzmannH5 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("BoltzmannH5 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("BoltzmannH5 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test1.newLine();

		//Write statistics for Boltzmann.
...
//		/***********************************************************************
//		 * Test #2: (20,000 roll-outs) Boltzmann v Charles_2.
//		 **********************************************************************/
//		e1TotalWins = 0;
//		totalDraws = 0;
//		e1TotalLoses = 0;
...
//		//Players participating in the test case.
//		Player[] playersTest2 =  {
//				new Player("Boltzmann", "Boltzmann", "w", 20000),
//				new Player("Charles_2", "Charles_2", "b", 0)
//		};
//
//		//Number of total moves. It is used to check whether the game is in 
...
//				} else if(playersTest2[currentIndexTest2].getType().equals("Boltzmann")) {
//					//MCTS (UCT) to play.
//					Tuple<Integer, Integer> move;
//					//Pure Monte-Carlo will select move.
//					MonteCarloH5Boltzmann mc = new MonteCarloH5Boltzmann(
...
//					new FileWriter("results_20k_BoltzmannvCharles_2.txt", true));
...
//		output1Test2.append("*Summary (20k) 3-point board (t=2.5)*");
//		output1Test2.newLine();
//		output1Test2.append("Draw occurred: " + totalDraws);
//		output1Test2.newLine();
//		output1Test2.append("Boltzmann total wins: " + e2TotalWins);
//		output1Test2.newLine();
...
//		output1Test2.append("Boltzmann wins as player #1 : " + e2WinAsPlayer1);
//		output1Test2.newLine();
//		output1Test2.append("Boltzmann wins as player #2 : " + e2WinAsPlayer2);
//		output1Test2.newLine();
//		output1Test2.append("Boltzmann draws as player #1 : " + e2DrawAsPlayer1);
//		output1Test2.newLine();
//		output1Test2.append("Boltzmann draws as player #2 : " + e2DrawAsPlayer2);
//		output1Test2.newLine();
//		output1Test2.append("Boltzmann loses as player #1 : " + e2LoseAsPlayer1);
//		output1Test2.newLine();
//		output1Test2.append("Boltzmann loses as player #2 : " + e2LoseAsPlayer2);
//		output1Test2.newLine();
//
...
//
//		/***********************************************************************
//		 * Test #3: (20,000 roll-outs) Boltzmann v MCTS + H(5).
//		 **********************************************************************/
//		e1TotalWins = 0;
//		totalDraws = 0;
//		e1TotalLoses = 0;
...
//		Player[] playersTest3 =  {
//				new Player("Boltzmann", "Boltzmann", "w", 20000),
//				new Player("MCTS + H(5)", "MCTS + H(5)", "b", 20000)
//		};
//
//		//Number of total moves. It is used to check whether the game is in 
//		//terminate state or not (the game finishes when there is no empty 
...
//				if(playersTest3[currentIndexTest3].getType().equals("MCTS + H(5)")) {
//					//MCTS + H(5) to play.
//					Tuple<Integer, Integer> move;
...
//				} else if(playersTest3[currentIndexTest3].getType().equals("Boltzmann")) {
//					//MCTS (UCT) to play.
//					Tuple<Integer, Integer> move;
//
//					//Pure Monte-Carlo will select move.
...
//					new FileWriter("results_50k_11b_BoltzmannvMCTS+H(5).txt", true));
...
//
//				//Update statistics.
//				if(playersTest3[0].getName().equals("MCTS + H(5)")) {
//					e1DrawAsPlayer1++;
//					e2DrawAsPlayer2++;
//				} else {
//					e1DrawAsPlayer2++;
...
//
//					//Update statistics.
//					if(playersTest3[1].getName().equals("MCTS + H(5)")) {
//						e1TotalWins++;
//						e2TotalLoses++;
//
//						e1WinAsPlayer2++;
...
//		output1Test3.newLine();
//		output1Test3.append("Boltzmann total wins: " + e2TotalWins);
//		output1Test3.newLine();
//		output1Test3.append("MCTS + H(5) total wins: " + e1TotalWins);
//		output1Test3.newLine();
//		output1Test3.append("Play time: " + (endTimeTest3 - startTimeTest3)/1000 + " seconds.");
//		output1Test3.newLine();
//
//		//Write statistics for MCTS.
//		output1Test3.append("Boltzmann wins as player #1 : " + e2WinAsPlayer1);
//		output1Test3.newLine();
//		output1Test3.append("Boltzmann wins as player #2 : " + e2WinAsPlayer2);
//		output1Test3.newLine();
//		output1Test3.append("Boltzmann draws as player #1 : " + e2DrawAsPlayer1);
//		output1Test3.newLine();
//		output1Test3.append("Boltzmann draws as player #2 : " + e2DrawAsPlayer2);
//		output1Test3.newLine();
//		output1Test3.append("Boltzmann loses as player #1 : " + e2LoseAsPlayer1);
//		output1Test3.newLine();
//		output1Test3.append("Boltzmann loses as player #2 : " + e2LoseAsPlayer2);
//		output1Test3.newLine();
//
//		//Write statistics for Random AI.
//		output1Test3.append("MCTS + H(5) wins as player #1 : " + e1WinAsPlayer1);
//		output1Test3.newLine();
//		output1Test3.append("MCTS + H(5) wins as player #2 : " + e1WinAsPlayer2);
//		output1Test3.newLine();
//		output1Test3.append("MCTS + H(5) draws as player #1 : " + e1DrawAsPlayer1);
//		output1Test3.newLine();
//		output1Test3.append("MCTS + H(5) draws as player #2 : " + e1DrawAsPlayer2);
//		output1Test3.newLine();
//		output1Test3.append("MCTS + H(5) loses as player #1 : " + e1LoseAsPlayer1);
//		output1Test3.newLine();
//		output1Test3.append("MCTS + H(5) loses as player #2 : " + e1LoseAsPlayer2);
//		output1Test3.newLine();
//
//		output1Test3.append("========================================");
//		output1Test3.close();
//
//		/***********************************************************************
//		 * Test #4: (50,000 roll-outs) Boltzmann v MCTS + H(7).
//		 **********************************************************************/
//		e1TotalWins = 0;
//		totalDraws = 0;
//		e1TotalLoses = 0;
...
//				new Player("Boltzmann", "Boltzmann", "b", 50000)
//		};
//
//		//Number of total moves. It is used to check whether the game is in 
//		//terminate state or not (the game finishes when there is no empty 
...
//				if(playersTest4[currentIndexTest4].getType().equals("Boltzmann")) {
//					//MCTS + H(5) to play.
//					Tuple<Integer, Integer> move;
//
//					//Pure Monte-Carlo + H(5) will select new move.
...
//					new FileWriter("results_50k_11b_MCTS+H(7)vBoltzmann.txt", true));
...
//
//				//Update statistics.
//				if(playersTest4[0].getName().equals("Boltzmann")) {
//					e1DrawAsPlayer1++;
//					e2DrawAsPlayer2++;
//				} else {
//					e1DrawAsPlayer2++;
...
//
//					//Update statistics.
//					if(playersTest4[1].getName().equals("Boltzmann")) {
//						e1TotalWins++;
//						e2TotalLoses++;
//
//						e1WinAsPlayer2++;
...
//		output1Test4.newLine();
//		output1Test4.append("Boltzmann total wins: " + e1TotalWins);
//		output1Test4.newLine();
...
//
//		//Write statistics for Random AI.
//		output1Test4.append("Boltzmann wins as player #1 : " + e1WinAsPlayer1);
//		output1Test4.newLine();
//		output1Test4.append("Boltzmann wins as player #2 : " + e1WinAsPlayer2);
//		output1Test4.newLine();
//		output1Test4.append("Boltzmann draws as player #1 : " + e1DrawAsPlayer1);
//		output1Test4.newLine();
//		output1Test4.append("Boltzmann draws as player #2 : " + e1DrawAsPlayer2);
//		output1Test4.newLine();
//		output1Test4.append("Boltzmann loses as player #1 : " + e1LoseAsPlayer1);
//		output1Test4.newLine();
//		output1Test4.append("Boltzmann loses as player #2 : " + e1LoseAsPlayer2);
//		output1Test4.newLine();
//
//		output1Test4.append("========================================");
//		output1Test4.close();
...
//		//Players participating in the test case.
//		Player[] playersTest5 =  {
//				new Player("Boltzmann", "Boltzmann", "w", 50000),
//				new Player("Charles_2", "Charles_2", "b", 0)
//		};
//
//		//Number of total moves. It is used to check whether the game is in 
...
//				} else if(playersTest5[currentIndexTest5].getType().equals("Boltzmann")) {
//					//MCTS (UCT) to play.
//					Tuple<Integer, Integer> move;
//					//Pure Monte-Carlo will select move.
//					MonteCarloH5Boltzmann mc = new MonteCarloH5Boltzmann(
...
//					new FileWriter("results_50k_11b_BoltzmannvCharles_2.txt", true));
...
//		output1Test5.newLine();
//		output1Test5.append("Boltzmann total wins: " + e2TotalWins);
//		output1Test5.newLine();
...
//
//		//Write statistics for MCTS.
//		output1Test5.append("Boltzmann wins as player #1 : " + e2WinAsPlayer1);
//		output1Test5.newLine();
//		output1Test5.append("Boltzmann wins as player #2 : " + e2WinAsPlayer2);
//		output1Test5.newLine();
//		output1Test5.append("Boltzmann draws as player #1 : " + e2DrawAsPlayer1);
//		output1Test5.newLine();
//		output1Test5.append("Boltzmann draws as player #2 : " + e2DrawAsPlayer2);
//		output1Test5.newLine();
//		output1Test5.append("Boltzmann loses as player #1 : " + e2LoseAsPlayer1);
//		output1Test5.newLine();
//		output1Test5.append("Boltzmann loses as player #2 : " + e2LoseAsPlayer2);
//		output1Test5.newLine();
//
//		//Write statistics for Random AI.
