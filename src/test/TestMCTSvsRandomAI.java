 ...
 *
 */
public class TestMCTSvsRandomAI {
	...
	public static void main(String[] args) throws Exception {
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			BufferedWriter output = new BufferedWriter(
					new FileWriter("results_MCTSvsRandom.txt", true));
		...
		output1.newLine();
		output1.append("Monte-Carlo (UCT) victory: " + montecaroloWinCount);
		output1.newLine();
