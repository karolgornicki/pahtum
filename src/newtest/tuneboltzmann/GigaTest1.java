	...
	public static void main(String[] args) throws Exception {
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			BufferedWriter outputTest1 = new BufferedWriter(
					new FileWriter("results_20k_3b_Boltzmann(5)_t=2.5vBoltzmann(5)_t=4.0.txt", true));
...
//					move = charles.getMove();
			...
			BufferedWriter outputTest2 = new BufferedWriter(
					new FileWriter("results_20k_3b_Boltzmann(5)_t=4.0vBoltzmann(5)_t=10.0.txt", true));
...
//					move = charles.getMove();
			...
			BufferedWriter outputTest3 = new BufferedWriter(
					new FileWriter("results_20k_3b_Boltzmann(5)_t=1.5vBoltzmann(5)_t=2.5.txt", true));
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest4 = new BufferedWriter(
					new FileWriter("results_20k_3b_Charles_2vBoltzmann(5)_t=1.5.txt", true));
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest5 = new BufferedWriter(
					new FileWriter("results_20k_3b_Boltzmann(5)_t=4.0vCharles_2.txt", true));
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest6 = new BufferedWriter(
					new FileWriter("results_20k_3b_Boltzmann(5)_t=10.0vCharles_2.txt", true));
