...
import ai.mch5boltzmann_t100.MonteCarloH5Boltzmann_t100;
import ai.mch5boltzmann_t15.MonteCarloH5Boltzmann_t15;
import ai.mch5boltzmann_t40.MonteCarloH5Boltzmann_t40;
...
public class GigaTest3 {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * Boltzmann(5)_t=2.5 v Boltzmann(5)_t=4.0
		 **********************************************************************/
		...
		Player[] playersTest1 =  {
				new Player("Boltzmann(5)_t=2.5", "Boltzmann(5)_t=2.5", "w", 20000),
				new Player("Boltzmann(5)_t=4.0", "Boltzmann(5)_t=4.0", "b", 20000)
		};
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest1 < totalNumberOfMovesTest1) {
				if(playersTest1[currentIndexTest1].getType().equals("Boltzmann(5)_t=2.5")) {
					//MCTS + H(7) to play.
				...
				} else if(playersTest1[currentIndexTest1].getType().equals("Boltzmann(5)_t=4.0")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloH5Boltzmann_t40 mc = new MonteCarloH5Boltzmann_t40(
							boardTest1.duplicate(), 
							playersTest1[currentIndexTest1].getColor(), 
							numberOfMoveTest1, 
							totalNumberOfMovesTest1);
			...
			BufferedWriter outputTest1 = new BufferedWriter(
					new FileWriter("results_20k_11b_Boltzmann(5)_t=2.5vBoltzmann(5)_t=4.0.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest1[0].getName().equals("Boltzmann(5)_t=4.0")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest1[0].getColor())) {
					...
					//Update statistics.
					if(playersTest1[1].getName().equals("Boltzmann(5)_t=4.0")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=2.5 total wins: " + e2TotalWins);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=4.0 total wins: " + e1TotalWins);
		output1Test1.newLine();
		output1Test1.append("Play time: " + (endTime - startTime)/1000 + " seconds.");
		output1Test1.newLine();

		//Write statistics for Charles_2.
		output1Test1.append("Boltzmann(5)_t=2.5 wins as player #1 : " + e2WinAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=2.5 wins as player #2 : " + e2WinAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=2.5 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=2.5 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=2.5 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=2.5 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test1.newLine();

		//Write statistics for Random AI.
		output1Test1.append("Boltzmann(5)_t=4.0 wins as player #1 : " + e1WinAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=4.0 wins as player #2 : " + e1WinAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=4.0 draws as player #1 : " + e1DrawAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=4.0 draws as player #2 : " + e1DrawAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=4.0 loses as player #1 : " + e1LoseAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann(5)_t=4.0) loses as player #2 : " + e1LoseAsPlayer2);
		output1Test1.newLine();
		...
		//Players participating in the test case.
		Player[] playersTest2 =  {
				new Player("Boltzmann(5)_t=4.0", "Boltzmann(5)_t=4.0", "w", 20000),
				new Player("Boltzmann(5)_t=10.0", "Boltzmann(5)_t=10.0", "b", 20000)
		};
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest2 < totalNumberOfMovesTest2) {
				if(playersTest2[currentIndexTest2].getType().equals("Boltzmann(5)_t=10.0")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloH5Boltzmann_t100 mc = new MonteCarloH5Boltzmann_t100(
				...
				} else if(playersTest2[currentIndexTest2].getType().equals("Boltzmann(5)_t=4.0")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloH5Boltzmann_t40 mc = new MonteCarloH5Boltzmann_t40(
...
//					move = charles.getMove();
			...
			BufferedWriter outputTest2 = new BufferedWriter(
					new FileWriter("results_20k_11b_Boltzmann(5)_t=4.0vBoltzmann(5)_t=10.0.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest2[0].getName().equals("Boltzmann(5)_t=10.0")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest2[0].getColor())) {
					...
					//Update statistics.
					if(playersTest2[1].getName().equals("Boltzmann(5)_t=10.0")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=4.0 total wins: " + e2TotalWins);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=10.0 total wins: " + e1TotalWins);
		output1Test2.newLine();
		output1Test2.append("Play time: " + (endTimeTest2 - startTimeTest2)/1000 + " seconds.");
		output1Test2.newLine();

		//Write statistics for MCTS.
		output1Test2.append("Boltzmann(5)_t=4.0 wins as player #1 : " + e2WinAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=4.0 wins as player #2 : " + e2WinAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=4.0 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=4.0 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=4.0 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=4.0 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test2.newLine();

		//Write statistics for Random AI.
		output1Test2.append("Boltzmann(5)_t=10.0 wins as player #1 : " + e1WinAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=10.0 wins as player #2 : " + e1WinAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=10.0 draws as player #1 : " + e1DrawAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=10.0 draws as player #2 : " + e1DrawAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=10.0 loses as player #1 : " + e1LoseAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann(5)_t=10.0 loses as player #2 : " + e1LoseAsPlayer2);
		output1Test2.newLine();
		...
		//Players participating in the test case.
		Player[] playersTest3 =  {
				new Player("Boltzmann(5)_t=1.5", "Boltzmann(5)_t=1.5", "w", 20000),
				new Player("Boltzmann(5)_t=2.5", "Boltzmann(5)_t=2.5", "b", 20000)
		};
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest3 < totalNumberOfMovesTest3) {
				if(playersTest3[currentIndexTest3].getType().equals("Boltzmann(5)_t=2.5")) {
					//MCTS + H(5) to play.
					Tuple<Integer, Integer> move;
				...
				} else if(playersTest3[currentIndexTest3].getType().equals("Boltzmann(5)_t=1.5")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;

//					Pure Monte-Carlo will select move.
					MonteCarloH5Boltzmann_t15 mc = new MonteCarloH5Boltzmann_t15(
							boardTest3.duplicate(), 
							playersTest3[currentIndexTest3].getColor(), 
							numberOfMoveTest3, 
							totalNumberOfMovesTest3);
...
//					move = charles.getMove();
			...
			BufferedWriter outputTest3 = new BufferedWriter(
					new FileWriter("results_20k_11b_Boltzmann(5)_t=1.5vBoltzmann(5)_t=2.5.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest3[0].getName().equals("Boltzmann(5)_t=2.5")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest3[0].getColor())) {
					...
					//Update statistics.
					if(playersTest3[1].getName().equals("Boltzmann(5)_t=2.5")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=1.5 total wins: " + e2TotalWins);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=2.5 total wins: " + e1TotalWins);
		output1Test3.newLine();
		output1Test3.append("Play time: " + (endTimeTest3 - startTimeTest3)/1000 + " seconds.");
		output1Test3.newLine();

		//Write statistics for MCTS.
		output1Test3.append("Boltzmann(5)_t=1.5 wins as player #1 : " + e2WinAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=1.5 wins as player #2 : " + e2WinAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=1.5 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=1.5 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=1.5 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=1.5 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test3.newLine();

		//Write statistics for Random AI.
		output1Test3.append("Boltzmann(5)_t=2.5 wins as player #1 : " + e1WinAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=2.5 wins as player #2 : " + e1WinAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=2.5 draws as player #1 : " + e1DrawAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=2.5 draws as player #2 : " + e1DrawAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=2.5 loses as player #1 : " + e1LoseAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann(5)_t=2.5 loses as player #2 : " + e1LoseAsPlayer2);
		output1Test3.newLine();
		...
		Player[] playersTest4 =  {
				...
				new Player("Boltzmann(5)_t=1.5", "Boltzmann(5)_t=1.5", "b", 20000)
		};
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest4 < totalNumberOfMovesTest4) {
				if(playersTest4[currentIndexTest4].getType().equals("Boltzmann(5)_t=1.5")) {
					//MCTS + H(5) to play.
					Tuple<Integer, Integer> move;
...
//							getSimulationNumber());
			...
			BufferedWriter outputTest4 = new BufferedWriter(
					new FileWriter("results_20k_11b_Charles_2vBoltzmann(5)_t=1.5.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest4[0].getName().equals("Boltzmann(5)_t=1.5")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest4[0].getColor())) {
					...
					//Update statistics.
					if(playersTest4[1].getName().equals("Boltzmann(5)_t=1.5")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test4.newLine();
		output1Test4.append("Boltzmann(5)_t=1.5 total wins: " + e1TotalWins);
		output1Test4.newLine();
		...
		//Write statistics for Random AI.
		output1Test4.append("Boltzmann(5)_t=1.5 wins as player #1 : " + e1WinAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Boltzmann(5)_t=1.5 wins as player #2 : " + e1WinAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("Boltzmann(5)_t=1.5 draws as player #1 : " + e1DrawAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Boltzmann(5)_t=1.5 draws as player #2 : " + e1DrawAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("Boltzmann(5)_t=1.5 loses as player #1 : " + e1LoseAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Boltzmann(5)_t=1.5 loses as player #2 : " + e1LoseAsPlayer2);
		output1Test4.newLine();
...
//							getSimulationNumber());
				...
				} else if(playersTest5[currentIndexTest5].getType().equals("Boltzmann(5)_t=4.0")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloH5Boltzmann_t40 mc = new MonteCarloH5Boltzmann_t40(
			...
			BufferedWriter outputTest5 = new BufferedWriter(
					new FileWriter("results_20k_11b_Boltzmann(5)_t=4.0vCharles_2.txt", true));
		...
		output1Test5.newLine();
		output1Test5.append("Boltzmann(5)_t=4.0 total wins: " + e2TotalWins);
		output1Test5.newLine();
		...
		//Write statistics for MCTS.
		output1Test5.append("Boltzmann(5)_t=4.0 wins as player #1 : " + e2WinAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("Boltzmann(5)_t=4.0 wins as player #2 : " + e2WinAsPlayer2);
		output1Test5.newLine();
		output1Test5.append("Boltzmann(5)_t=4.0 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("Boltzmann(5)_t=4.0 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test5.newLine();
		output1Test5.append("Boltzmann(5)_t=4.0 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("Boltzmann(5)_t=4.0 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test5.newLine();
		...
		//Players participating in the test case.
		Player[] playersTest6 =  {
				new Player("Boltzmann(5)_t=10.0", "Boltzmann(5)_t=10.0", "w", 20000),
				new Player("Charles_2", "Charles_2", "b", 0)
		};
...
//							getSimulationNumber());
				...
				} else if(playersTest6[currentIndexTest6].getType().equals("Boltzmann(5)_t=10.0")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarloH5Boltzmann_t100 mc = new MonteCarloH5Boltzmann_t100(
			...
			BufferedWriter outputTest6 = new BufferedWriter(
					new FileWriter("results_20k_11b_Boltzmann(5)_t=10.0vCharles_2.txt", true));
		...
		output1Test6.newLine();
		output1Test6.append("Boltzmann(5)_t=10.0 total wins: " + e2TotalWins);
		output1Test6.newLine();
		...
		output1Test6.append("Boltzmann(5)_t=10.0 wins as player #1 : " + e2WinAsPlayer1);
		output1Test6.newLine();
		output1Test6.append("Boltzmann(5)_t=10.0 wins as player #2 : " + e2WinAsPlayer2);
		output1Test6.newLine();
		output1Test6.append("Boltzmann(5)_t=10.0 draws as player #1 : " + e2DrawAsPlayer1);
		output1Test6.newLine();
		output1Test6.append("Boltzmann(5)_t=10.0 draws as player #2 : " + e2DrawAsPlayer2);
		output1Test6.newLine();
		output1Test6.append("Boltzmann(5)_t=10.0 loses as player #1 : " + e2LoseAsPlayer1);
		output1Test6.newLine();
		output1Test6.append("Boltzmann(5)_t=10.0 loses as player #2 : " + e2LoseAsPlayer2);
		output1Test6.newLine();
