...
public class GigaTest4 {
	...
	public static void main(String[] args) throws Exception {
		...
		Player[] playersTest1 =  {
				new Player("Boltzmann5_(t=2.5)_20k", "Boltzmann5_(t=2.5)_20k", "w", 20000),
				new Player("MCTS_UCT_100k", "MCTS_UCT_100k", "b", 100000)
		};
		...
		//Load board.
		try {
			FileInputStream fisTest1 = new FileInputStream("200_boards_3.sav");
		...
		for(int testIndex = 1; testIndex <= 400; ++testIndex) {
			System.out.println("Test1: " + testIndex + " / 400");
			//Reset settings.
			currentIndexTest1 = 0;
			numberOfMoveTest1 = 0;
			...
			while(numberOfMoveTest1 < totalNumberOfMovesTest1) {
				if(playersTest1[currentIndexTest1].getType().equals("Boltzmann5_(t=2.5)_20k")) {
					//MCTS + H(7) to play.
				...
				} else if(playersTest1[currentIndexTest1].getType().equals("MCTS_UCT_100k")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
			...
			BufferedWriter outputTest1 = new BufferedWriter(
					new FileWriter("results_3b_Boltzmann5_20kvMCTS_UCT_100k.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest1[0].getName().equals("MCTS_UCT_100k")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest1[0].getColor())) {
					...
					//Update statistics.
					if(playersTest1[1].getName().equals("MCTS_UCT_100k")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test1.append("*Summary 3-point board 20k/100k roll-outs*");
		output1Test1.newLine();
		output1Test1.append("Draw occurred: " + totalDraws);
		output1Test1.newLine();
		output1Test1.append("Boltzmann5_(t=2.5)_20k total wins: " + e2TotalWins);
		output1Test1.newLine();
		output1Test1.append("MCTS_UCT_100k total wins: " + e1TotalWins);
		output1Test1.newLine();
		output1Test1.append("Play time: " + (endTime - startTime)/1000 + " seconds.");
		output1Test1.newLine();

		//Write statistics for Boltzmann5.
		output1Test1.append("Boltzmann5_(t=2.5)_20k wins as player #1 : " + e2WinAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann5_(t=2.5)_20k wins as player #2 : " + e2WinAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("Boltzmann5_(t=2.5)_20k draws as player #1 : " + e2DrawAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann5_(t=2.5)_20k draws as player #2 : " + e2DrawAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("Boltzmann5_(t=2.5)_20k loses as player #1 : " + e2LoseAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("Boltzmann5_(t=2.5)_20k loses as player #2 : " + e2LoseAsPlayer2);
		output1Test1.newLine();

		//Write statistics for Random AI.
		output1Test1.append("MCTS_UCT_100k wins as player #1 : " + e1WinAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("MCTS_UCT_100k wins as player #2 : " + e1WinAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("MCTS_UCT_100k draws as player #1 : " + e1DrawAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("MCTS_UCT_100k draws as player #2 : " + e1DrawAsPlayer2);
		output1Test1.newLine();
		output1Test1.append("MCTS_UCT_100k loses as player #1 : " + e1LoseAsPlayer1);
		output1Test1.newLine();
		output1Test1.append("MCTS_UCT_100k loses as player #2 : " + e1LoseAsPlayer2);
		output1Test1.newLine();
		...
		//Players participating in the test case.
		Player[] playersTest2 =  {
				new Player("Boltzmann7_(t=2.5)", "Boltzmann7_(t=2.5)", "w", 20000),
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest2 < totalNumberOfMovesTest2) {
				...
				} else if(playersTest2[currentIndexTest2].getType().equals("Boltzmann7_(t=2.5)")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
			...
			BufferedWriter outputTest2 = new BufferedWriter(
					new FileWriter("results_20k_3b_Boltzmann7_(t=2.5)vCharles_2.txt", true));
		...
		output1Test2.newLine();
		output1Test2.append("Boltzmann7_(t=2.5) total wins: " + e2TotalWins);
		output1Test2.newLine();
		...
		//Write statistics for Boltzmann5.
		output1Test2.append("Boltzmann7_(t=2.5) wins as player #1 : " + e2WinAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann7_(t=2.5) wins as player #2 : " + e2WinAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("Boltzmann7_(t=2.5) draws as player #1 : " + e2DrawAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann7_(t=2.5) draws as player #2 : " + e2DrawAsPlayer2);
		output1Test2.newLine();
		output1Test2.append("Boltzmann7_(t=2.5) loses as player #1 : " + e2LoseAsPlayer1);
		output1Test2.newLine();
		output1Test2.append("Boltzmann7_(t=2.5) loses as player #2 : " + e2LoseAsPlayer2);
		output1Test2.newLine();
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest3 < totalNumberOfMovesTest3) {
				if(playersTest3[currentIndexTest3].getType().equals("Charles_2")) {
					//MCTS + H(5) to play.
					Tuple<Integer, Integer> move;
				...
				} else if(playersTest3[currentIndexTest3].getType().equals("Boltzmann7_(t=2.5)")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
			...
			BufferedWriter outputTest3 = new BufferedWriter(
					new FileWriter("results_20k_11b_Boltzmann7_(t=2.5)vCharles_2.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest3[0].getName().equals("Charles_2")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest3[0].getColor())) {
					...
					//Update statistics.
					if(playersTest3[1].getName().equals("Charles_2")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test3.newLine();
		output1Test3.append("Boltzmann7_(t=2.5) total wins: " + e2TotalWins);
		output1Test3.newLine();
		output1Test3.append("Charles_2 total wins: " + e1TotalWins);
		output1Test3.newLine();
		output1Test3.append("Play time: " + (endTimeTest3 - startTimeTest3)/1000 + " seconds.");
		output1Test3.newLine();

		//Write statistics for MCTS.
		output1Test3.append("Boltzmann7_(t=2.5) wins as player #1 : " + e2WinAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann7_(t=2.5) wins as player #2 : " + e2WinAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("Boltzmann7_(t=2.5) draws as player #1 : " + e2DrawAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann7_(t=2.5) draws as player #2 : " + e2DrawAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("Boltzmann7_(t=2.5) loses as player #1 : " + e2LoseAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Boltzmann7_(t=2.5) loses as player #2 : " + e2LoseAsPlayer2);
		output1Test3.newLine();

		//Write statistics for Random AI.
		output1Test3.append("Charles_2 wins as player #1 : " + e1WinAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Charles_2 wins as player #2 : " + e1WinAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("Charles_2 draws as player #1 : " + e1DrawAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Charles_2 draws as player #2 : " + e1DrawAsPlayer2);
		output1Test3.newLine();
		output1Test3.append("Charles_2 loses as player #1 : " + e1LoseAsPlayer1);
		output1Test3.newLine();
		output1Test3.append("Charles_2 loses as player #2 : " + e1LoseAsPlayer2);
		output1Test3.newLine();
		...
		//Players participating in the test case.
		Player[] playersTest4 =  {
				new Player("Boltzmann5_(t=2.5)", "Boltzmann5_(t=2.5)", "w", 20000),
				new Player("Charles_2", "Charles_2", "b", 0)
		};
		...
		for(int testIndex = 1; testIndex <= 100; ++testIndex) {
			...
			while(numberOfMoveTest4 < totalNumberOfMovesTest4) {
				if(playersTest4[currentIndexTest4].getType().equals("Charles_2")) {
					//MCTS + H(5) to play.
					Tuple<Integer, Integer> move;
				...
				} else if(playersTest4[currentIndexTest4].getType().equals("Boltzmann5_(t=2.5)")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
			...
			BufferedWriter outputTest4 = new BufferedWriter(
					new FileWriter("results_20k_11b_Boltzmann5_(t=2.5)vCharles_2.txt", true));
			...
			if(gameOutcome.equals("0")) {
				...
				//Update statistics.
				if(playersTest4[0].getName().equals("Charles_2")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest4[0].getColor())) {
					...
					//Update statistics.
					if(playersTest4[1].getName().equals("Charles_2")) {
						e1TotalWins++;
						e2TotalLoses++;
		...
		output1Test4.newLine();
		output1Test4.append("Boltzmann5_(t=2.5) total wins: " + e2TotalWins);
		output1Test4.newLine();
		output1Test4.append("Charles_2 total wins: " + e1TotalWins);
		output1Test4.newLine();
		output1Test4.append("Play time: " + (endTimeTest4 - startTimeTest4)/1000 + " seconds.");
		output1Test4.newLine();

		//Write statistics for MCTS.
		output1Test4.append("Boltzmann5_(t=2.5) wins as player #1 : " + e2WinAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Boltzmann5_(t=2.5) wins as player #2 : " + e2WinAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("Boltzmann5_(t=2.5) draws as player #1 : " + e2DrawAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Boltzmann5_(t=2.5) draws as player #2 : " + e2DrawAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("Boltzmann5_(t=2.5) loses as player #1 : " + e2LoseAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Boltzmann5_(t=2.5) loses as player #2 : " + e2LoseAsPlayer2);
		output1Test4.newLine();

		//Write statistics for Random AI.
		output1Test4.append("Charles_2 wins as player #1 : " + e1WinAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Charles_2 wins as player #2 : " + e1WinAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("Charles_2 draws as player #1 : " + e1DrawAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Charles_2 draws as player #2 : " + e1DrawAsPlayer2);
		output1Test4.newLine();
		output1Test4.append("Charles_2 loses as player #1 : " + e1LoseAsPlayer1);
		output1Test4.newLine();
		output1Test4.append("Charles_2 loses as player #2 : " + e1LoseAsPlayer2);
		output1Test4.newLine();
		...
		//Players participating in the test case.
		Player[] playersTest5 =  {
				new Player("MCTS_UCT_100k", "MCTS_UCT_100k", "w", 100000),
				new Player("Charles_2", "Charles_2", "b", 0)
		};
		...
		//Load board.
		try {
			FileInputStream fisTest5 = new FileInputStream("200_boards_3.sav");
		...
		//Boards are OK. Proceed to testing.
		for(int testIndex = 1; testIndex <= 400; ++testIndex) {
			System.out.println("Test5: " + testIndex + " / 400");
			//Reset settings.
			currentIndexTest5 = 0;
			numberOfMoveTest5 = 0;
			...
			while(numberOfMoveTest5 < totalNumberOfMovesTest5) {
				...
				} else if(playersTest5[currentIndexTest5].getType().equals("MCTS_UCT_100k")) {
					//MCTS (UCT) to play.
					Tuple<Integer, Integer> move;
					//Pure Monte-Carlo will select move.
					MonteCarlo mc = new MonteCarlo(
			...
			BufferedWriter outputTest5 = new BufferedWriter(
					new FileWriter("results_100k_3b_MCTS_UCT_100kvCharles_2.txt", true));
		...
		output1Test5.newLine();
		output1Test5.append("MCTS_UCT_100k total wins: " + e2TotalWins);
		output1Test5.newLine();
		...
		//Write statistics for MCTS.
		output1Test5.append("MCTS_UCT_100k wins as player #1 : " + e2WinAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("MCTS_UCT_100k wins as player #2 : " + e2WinAsPlayer2);
		output1Test5.newLine();
		output1Test5.append("MCTS_UCT_100k draws as player #1 : " + e2DrawAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("MCTS_UCT_100k draws as player #2 : " + e2DrawAsPlayer2);
		output1Test5.newLine();
		output1Test5.append("MCTS_UCT_100k loses as player #1 : " + e2LoseAsPlayer1);
		output1Test5.newLine();
		output1Test5.append("MCTS_UCT_100k loses as player #2 : " + e2LoseAsPlayer2);
		output1Test5.newLine();
